...
if __name__ == "__main__":
    ...
    for th1 in tqdm(th1_range):
        for th2 in th2_range:
            ...
            #p1, p2 = ljung_p_value(th1, th2, lags)
            # vals.append(max(p1, p2))
    ...
    vals = np.array(vals)
    # col_vals = cat_vals(np.array(vals))
    # plt.scatter(points_th1, points_th2, c=col_vals, s=10)
    ...
    # ax.scatter3D(D_1, D_2,
    #              [stats.chi2.cdf(0.995, nlags)])
    plt.show()
