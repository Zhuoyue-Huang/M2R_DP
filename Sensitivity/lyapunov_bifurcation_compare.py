...
plt.plot(np.arange(180), val1, color="#00008B")
plt.plot(np.arange(180), val2, color="#0343DF")
plt.plot(np.arange(180), val3, color="dodgerblue")
plt.plot(np.arange(180), val4, color="#7BC8F6")
plt.xlabel(r"$\theta_1$", fontsize=17)
plt.ylabel("Lyapunov exponent", fontsize=17)
plt.legend([r"$\theta_1(0)=\theta_2(0)$", r"$\theta_1(0)=\sqrt{2}\theta_2(0)$", r"$\theta_1(0)=-\sqrt{2}\theta_2(0)$", r"$\theta_1(0)=3\theta_2(0)$"], prop={'size': 13})
plt.xlim(0,180)
plt.tight_layout()
...
scatter = ax.scatter(points_th1, points_th2, c=vals, cmap='hot', s=53, linewidth=0)
